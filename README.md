...
<table>
  <tr>
    ...
    <td>HTML • CSS • JavaScript (ES6+) • TypeScript </td>
  </tr>
  <tr>
    <td><strong>Backend</strong></td>
    <td>Node.js • Express • Django • REST APIs • GraphQL (optional)</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Jest • PyTest • Postman</td>
  </tr>
</table>

<!-- Quick skill badges (edit freely) -->
<p>
...
<!--   <a href="{{ REPO_URL_1 }}">🔗 Repository</a> •
  ...
  <a href="{{ CASE_STUDY_OR_DOCS_URL_1 }}">📄 Case Study</a> -->
</div>
...
<!--   <tr>
    ...
    <td>{{ YYYY – YYYY }} • {{ ACHIEVEMENTS / IMPACT }}</td>
  </tr> -->
</table>
